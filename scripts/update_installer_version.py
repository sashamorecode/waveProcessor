...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=waveProcessor Demo Installer\n"
      else:
        line="OutputBaseFilename=waveProcessor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the waveProcessor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the waveProcessor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=waveProcessor Demo installer\n"
     else:
       line="SetupWindowTitle=waveProcessor installer\n"
